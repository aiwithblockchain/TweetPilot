...
export default function ReplyGenerationView() {
	...
	const [selectedReply, setSelectedReply] = useState<CandidateReply | null>(
		null,
	);
	const [isLoadingComments, setIsLoadingComments] = useState(true);
	const { generateReplies, isGenerating, replies, error, trace } =
		useReplyGeneration();
	...
	const selectedComment =
		commentInputs.find(
			(commentInput) => commentInput.id === selectedCommentId,
		) ?? null;
		...
		<div className="reply-generation-layout">
			<section className="panel reply-panel">
				...
				{isLoadingComments ? (
					...
					<p className="muted">
						No comment inputs available for reply generation.
					</p>
				) : (
